    ...
    switch (response.statusCode) {
      ...
      case 500:
        try {
          ...
          // Nếu lỗi ném ra chính là Exception từ khối try phía trên, giữ nguyên nó để chuyển ra UI
          if (e is Exception) rethrow;
          
          // Ngược lại, ném ra lỗi fallback nếu response body không phải chuỗi JSON hợp lệ
